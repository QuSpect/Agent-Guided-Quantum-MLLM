#!/usr/bin/env python3
"""Run locked base/scaffold/QH042/CC042 arms."""
...
PROJECT=Path(__file__).resolve().parents[2];LOCK=PROJECT/"artifacts/qh042-xz-screen-lock.json";TOKENS=PROJECT/"datasets/processed/wikitext2_qwen38/train-tokens.pt";BACKBONE=PROJECT/"artifacts/qh037_grouped_qvaf_screen/cc037-screen-checkpoint.pt";SOURCE=PROJECT/"code/src/quantum_qwen38/qh042_signed_xz_correlator_residual.py";ENTRY=PROJECT/"code/scripts/run_qh042_xz_screen.py";OUT=PROJECT/"artifacts/qh042_xz_screen";sys.path.insert(0,str(PROJECT/"code/src"))
from quantum_qwen38.qh042_signed_xz_correlator_residual import QH042Config,install_qh042
...
def main():
 ...
 if a.candidate in {"qh042","cc042"}:save(rep,opt,OUT/f"{a.candidate}-screen-checkpoint.pt",a.candidate,cfg,tr,model_dir)
